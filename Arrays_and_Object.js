...
let equivalentValueInAUD = Euros * exchangeRate;
console.log(equivalentValueInAUD);
...
console.log('The highest currency is ${highestCurrency} with rate ${highestExchangeRate}');
...
console.log(cats_and_owners.find(owner => owner.name === "Gary Oldman").cat);
cats_and_owners.push({name: "Taylor Swift", cat: "Meredith"})

owner.forEach(function(owner, cat) {
  console.log('${owner.name} cat is called ${owner.cat}');
})
...
let literatureLaureate = nobel_prize_winners_2017.prizes.find(prize => prize.category === 'literature');
console.log(literatureLaureate.laureates[0].firstname + " " + literatureLaureate.laureates[0].surname);
...
nobel_prize_winners_2017.prizes.forEach(prize => totalLaureates += prize.laureates.length);
